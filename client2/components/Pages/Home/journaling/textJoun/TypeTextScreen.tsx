...
const TypeTextScreen:React.FC<NewProps> = ({
    ...
    return(<View style={s.container}>
        <View style={s.header}>
            <Image source={{uri: "https://images.unsplash.com/photo-1710896460187-ecaba345d0d9?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"}} style={s.icon}/>
        </View>
